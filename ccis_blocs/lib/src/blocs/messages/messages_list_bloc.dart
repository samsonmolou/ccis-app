...
class MessagesListBloc {
  ...
  factory MessagesListBloc(MessagesInteractor interactor) {
    ...
    final addMessageController = StreamController<Message>(sync: true);
    ...
    final subscriptions = <StreamSubscription<dynamic>>[
      ...
      addMessageController.stream.listen(interactor.addNewMessage),
