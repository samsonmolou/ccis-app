...
class MemberSearchBloc {
  ...
  factory MemberSearchBloc(MembersInteractor interactor) {
    ...
    return MemberSearchBloc._(
        searchMemberController, searchMemberResultController, subscriptions);
  }

  MemberSearchBloc._(
      this.searchMember, this.searchMemberResult, this._subscriptions);

  static List<Member> _searchMembers(List<Member> members, String query) {
    final Iterable<Member> suggestions = Search.searchMember(members, query);
