...
import 'package:ccis_blocs/src/interactors/studies_interactor.dart';
import 'package:ccis_blocs/src/models/models.dart';

class StudiesListBloc {
  // Data

  // Inputs

  // Outputs
  final Stream<List<Study>> studies;

  // Cleanup
  final List<StreamSubscription<dynamic>> _subscriptions;

  factory StudiesListBloc(StudiesInteractor interactor) {
