...
/// web or Flutter.
abstract class ReactiveBroadcastRepository {
  Stream<List<BroadcastEntity>> broadcasts();

  Future<void> addNewBroadcast(BroadcastEntity broadcast);

  Future<void> deleteBroadcast(List<String> idList);

  Future<void> updateBroadcast(BroadcastEntity broadcast);
}
